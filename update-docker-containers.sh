...
echo -e "${BOLD}${GREEN}  ____            _        _                   _   _           _       _            "
echo -e "${BOLD}${GREEN} / ___|___  _ __ | |_ __ _(_)_ __   ___ _ __  | | | |_ __   __| | __ _| |_ ___ _ __ "
echo -e "${BOLD}${GREEN}| |   / _ \| '_ \| __/ _` | | '_ \ / _ \ '__| | | | | '_ \ / _` |/ _` | __/ _ \ '__|"
echo -e "${BOLD}${GREEN}| |__| (_) | | | | || (_| | | | | |  __/ |    | |_| | |_) | (_| | (_| | ||  __/ |   "
echo -e "${BOLD}${GREEN} \____\___/|_| |_|\__\__,_|_|_| |_|\___|_|     \___/| .__/ \__,_|\__,_|\__\___|_|   "
echo -e "${BOLD}${GREEN}                                                    |_|                             "
